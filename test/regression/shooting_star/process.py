...
phi_fast = np.transpose(phi_fast)
phi_thermal = np.transpose(phi_thermal)
phi_fast_sd = np.transpose(phi_fast_sd)
phi_thermal_sd = np.transpose(phi_thermal_sd)
...
plt.pcolormesh(X, Z, phi_fast, shading="nearest")
plt.colorbar()
ax = plt.gca()
ax.set_aspect("equal")
plt.xlabel(r"$x$ [cm]")
...
plt.pcolormesh(X, Z, phi_fast_sd, shading="nearest")
plt.colorbar()
ax = plt.gca()
ax.set_aspect("equal")
plt.xlabel(r"$x$ [cm]")
...
plt.pcolormesh(X, Z, phi_thermal, shading="nearest")
plt.colorbar()
ax = plt.gca()
ax.set_aspect("equal")
plt.xlabel(r"$x$ [cm]")
...
plt.pcolormesh(X, Z, phi_thermal_sd, shading="nearest")
plt.colorbar()
ax = plt.gca()
ax.set_aspect("equal")
plt.xlabel(r"$x$ [cm]")
